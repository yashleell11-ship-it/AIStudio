"""Toonily online source connector."""
...
class ToonilyConnector(SourceConnector):
    """Browse and read manhwa from Toonily (Madara HTML catalog)."""
    ...
    def _log_request(
        ...
        *,
        ...
        message = (
            f"Toonily {operation} {SITE_BASE}{path} "
    ...
    def _remember_page_count(self, chapter_id: str, page_count: int) -> None:
        ...
        logger.info(
            "Toonily cached page_count chapter_id=%s count=%d",
            chapter_id,
            page_count,
        )
