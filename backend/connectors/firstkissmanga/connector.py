"""1st Kiss Manga online source connector."""
...
from connectors.firstkissmanga.http import FirstKissHttpClient
...
class FirstKissMangaConnector(SourceConnector):
    """Browse and read manhwa/manga from 1st Kiss Manga (Madara HTML catalog)."""

    SOURCE_TYPE = "1stkissmanga"
    DISPLAY_NAME = "1st Kiss Manga"
    DESCRIPTION = (
        "Browse and read manga and manhwa from 1st Kiss Manga. "
    ...
    def __init__(self) -> None:
        self._http = FirstKissHttpClient(
            SITE_BASE,
    ...
    def allowed_image_hosts(self) -> frozenset[str]:
        return frozenset({"1stkissmanga.io", "1stkmgv2.com"})
    ...
    def _log_request(
        ...
        *,
        ...
        message = (
            f"1st Kiss Manga {operation} {SITE_BASE}{path} "
