"""Madara-theme site catalog — one config per browsable source."""
...
MADARA_SITES: tuple[MadaraSiteConfig, ...] = (
    ...
    # Probed DEAD 2026-07-11: CF/SPA/parked — see CONNECTOR_STATUS.md
    ...
    # Probed DEAD 2026-07-11: Next.js /browse, not Madara
    ...
    # Probed DEAD 2026-07-11: anti-bot redirect
    ...
    # --- Manhwa 18+ (Madara / serie-style where noted) -----------------------
