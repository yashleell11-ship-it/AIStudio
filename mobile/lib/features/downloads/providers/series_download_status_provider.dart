...
/// starts from.
///
/// Re-fetches whenever [downloadQueueControllerProvider]'s state changes
/// (a chapter starts, finishes, fails, or the queue pauses) so a download
/// button's icon updates without the screen needing its own polling.
...
final seriesChapterDownloadStatusProvider = FutureProvider.autoDispose
  ...
  // Dependency only, to force a re-fetch on every queue state change.
