...
class _EmptyLibraryRepository implements LibraryRepository {
  ...
  @override
  Future<Result<List<SeriesSummary>>> recentlyAdded({int limit = 20}) async => const Ok([]);

  @override
  Future<Result<List<SeriesSummary>>> recentlyUpdated({int limit = 20}) async => const Ok([]);

  @override
  Future<Result<List<SeriesSummary>>> recommendations({int limit = 20}) async => const Ok([]);

  @override
  Future<Result<List<SeriesSummary>>> search(String query, {int page = 1}) async => const Ok([]);
